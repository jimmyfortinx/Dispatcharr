...
def generate_stream_url(
    ...
    Optional[str], Optional[str], Optional[dict], bool, Optional[int], bool,
    ...
    Returns:
        ...
        slot_reserved, error_reason, stream_id)
    """
    try:
        ...
        if isinstance(channel_or_stream, Stream):
            ...
            if not stream.m3u_account:
                ...
                return None, None, None, False, None, False, "Stream has no M3U account", None
            ...
            if not stream_id or not profile_id:
                ...
                return None, None, None, False, None, False, error_reason, None
            ...
            try:
                ...
                return stream_url, stream_user_agent, stream_context.get('input_headers'), transcode, stream_profile_id, slot_reserved, None, stream.id
            except Exception as e:
                logger.error(f"Error generating stream URL for stream {stream.id}: {e}")
                if slot_reserved:
                    stream.release_stream()
                return None, None, None, False, None, False, str(e), None
...
def get_stream_info_for_switch(
    ...
    try:
        ...
        if isinstance(channel_or_stream, Stream):
            ...
            stream_id, m3u_profile_id, error_reason, slot_reserved = stream.get_stream()
